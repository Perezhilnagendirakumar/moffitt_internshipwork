...
## Seurat H5 file
h5_file <- "Single_Cell_RNAseq_Pipeline/Output/Single_Cell_RNAseq_Output/GSE116256_AMLscRNA_h5friendly.h5seurat"

## Specify the output folder path
output_folder <- "Single_Cell_RNAseq_Pipeline/Output/Single_Cell_PostProcessing_Output/"
