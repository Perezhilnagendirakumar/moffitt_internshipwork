...
Count_file <- "Single_Cell_RNAseq_Pipeline/Input/Count_File_Example_GSE116256_AML921A-D0.txt.gz"

# Define path to clinical/meta data (OPTIONAL)
meta_file <- "Single_Cell_RNAseq_Pipeline/Input/Meta_File_Example_GSE116256_AML921A-D0.txt.gz"

# Specify the output folder path
output_folder <- "Single_Cell_RNAseq_Pipeline/Output/Single_Cell_RNAseq_Output/"
